...
function Sidebar({
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>Показывает мобильное боковое меню.</SheetDescription>
          </SheetHeader>
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* Keeps the desktop sidebar gap in sync with the collapsed state. */}
      <div
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn("flex h-14 flex-col justify-center gap-2 px-2 py-0", className)}
      {...props}
    />
  )
}
